...
* Instead of populating the nested dictionary using Python or R code, perhaps employing Pandas or the dplyr count() method might increase performance. This won't solve the memory issue though.
